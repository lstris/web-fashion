...
<main>
<div class="con" style="display: flex; justify-content: center; align-items: center; margin: 50px -165px;">
        ...
        <form action="#" id="contact" style="margin: 0px -165px;">
            <div class="form-box">
                <div class="form-group">
                    <label for="paymentMethod" style="color: rgba(0, 0, 0, 0.6);">Phương thức thanh toán</label>
                    <select name="paymentMethod" id="paymentMethod" style="width: 900px;height: 40px;border: 2px solid rgba(0, 0, 0, 0.1);border-radius: 5px;outline: none;transition: all 0.2s linear;color: rgba(0, 0, 0, 0.6);" class="form-control">
                    ...
                    <span class="error-message" id="paymentMethod-error"></span>
                </div>
                <div class="form-group">
                ...
                <div class="form-group">
                    ...
                    <input class="form-control" name="phone" id="phone" type="text" rules="required">
                    <span class="error-message" id="phone-error"></span>
                </div>
                <div class="form-group">
                    <label for="address">Địa chỉ</label>
                    <input class="form-control" name="address" id="address" type="text" rules="required">
                    <span class="error-message" id="address-error"></span>
                </div>
            </div>
            <button type="submit" style="width: 200px;">Hoàn tất đơn hàng</button>
            <button type="button" style="width: 200px; background-color: #FFFFFF;"><a href="../controller/index.php">Tiếp tục mua sắp</a></button>
        </form>
    </div>
</div>
...
<script>
    document.getElementById('contact').addEventListener('submit', function (event) {
        ...
        document.getElementById('paymentMethod-error').textContent = '';
        ...
        if (paymentMethod === '1') {
    document.getElementById('paymentMethod-error').textContent = 'Vui lòng chọn phương thức thanh toán';
    document.getElementById('paymentMethod-error').style.color = 'red';
    return;
}
if (name === '') {
    ...
    <!-- <div class="con" style="display: flex; justify-content: center; align-items: center; margin: 50px -165px;">
        <div class="form-contact-box">
            ...
            <form action="#" id="contact" style="margin: 0px -165px;">
                ...
                <button type="submit" style="width: 200px;">Hoàn tất đơn hàng</button>
                <button type="submit" style="width: 200px; background-color: #FFFFFF;"><a href="../controller/index.php">Tiếp tục mua sắp</a></button>
            </form>
        </div>
    </div> -->
</main>
